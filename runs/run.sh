...
PATH=/usr/bin:$PATH LAW_CONFIG_FILE=/lustre/home/barmstrong/aframe_new/runs/base.cfg uv run --directory /lustre/home/barmstrong/aframe_new law run aframe.tasks.infer.Infer --gpus 0,1,2,3,4,5,6,7 --dev --train-task Infer --log-level DEBUG #--print-status -1 # --print-deps -1
